...
1. Any type of free and open access bio/medical data
2. Any type of bio/medical workflow, ideally submitted as a runnable 'document'
3. Any type of free and open source bio/medical software

or combination thereof, provided the work directly relates to
...
6. On acceptance you are on track for world fame

## Community effort and research


Note that this journal is a work in progress (WIP) and ongoing
research project. We are in the process of adding datasets and
publications, essentially by adding descriptions and metadata as files
to [this repository]. You are invited to submit your own.

An example
of a publication can be found [here] with its JSON-LD [metadata]. The
source code that makes this journal is fully free and open source
software written by working bioinformaticians. The journal is hosted
through small donations out of research budgets. Both software and
data are online available and anyone can copy and host the journal
anywhere - this is just a piece of infrastructure. You can do with it
what you want and take the source code and and database and improve on
...
principles, automated submission systems (do we always need peer
review?), graph databases, reproducible analysis, and/or improving
people's academic track records. This is the time to break free! Use
your <b>imagination</b>.
